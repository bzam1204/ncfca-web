      ...
      <Sheet>
        ...
        <SheetContent side="left" className="flex flex-col">
          <SheetHeader>
            ...
            <SheetDescription className="sr-only">Navegue pelas seções de administração.</SheetDescription>
          </SheetHeader>
          ...
          <SheetFooter className="mt-auto border-t pt-4">
            <div className="flex items-center justify-between w-full">
              <div className="flex flex-col">
                <span className="text-sm font-semibold leading-none">{session?.user?.name || session?.user?.email}</span>
