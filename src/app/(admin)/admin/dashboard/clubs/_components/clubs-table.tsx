...
export function ClubsTable({ initialClubs, allUsers }: ClubsTableProps) {
  ...
  return (
    <>
                ...
                <TableCell className="text-right">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem onSelect={() => setSelectedClub(club)}>Alterar Diretor</DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                </TableCell>
              </TableRow>
      ...
      <ChangePrincipalDialog isOpen={!!selectedClub} club={selectedClub} onClose={() => setSelectedClub(null)} />
    </>
  );
}
