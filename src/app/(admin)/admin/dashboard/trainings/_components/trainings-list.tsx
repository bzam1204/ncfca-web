    ...
    <>
      {query.trainings.length === 0 ? (
        <Alert>
          ...
          <AlertDescription>Comece criando seu primeiro treinamento clicando no botão `&quot;`Novo Treinamento`&quot;`.</AlertDescription>
        </Alert>
      ) : (
            ...
            <Card key={training.id} className="flex flex-col">
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        ...
                        <AlertDialogFooter>
                          ...
                          <AlertDialogAction onClick={() => deleteTrainingMutation.mutate(training.id)} disabled={deleteTrainingMutation.isPending}>
              ...
              <CardContent className="flex-1 flex flex-col justify-end">
                {training.getYouTubeVideoId() ? (
                  <YouTubePlayer videoId={training.getYouTubeVideoId()!} title={training.title} className="rounded-lg" />
                ) : (
