    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <InfoField
            label="Perfis"
            value={holder.roles.map((role) => (
              <Badge className="mr-2 mt-2" key={role} variant="secondary">
                {role}
              </Badge>
            ))}
          />
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-3">
            <Home className="h-6 w-6" /> Endereço
          </CardTitle>
        </CardHeader>
        <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-3">
            <FamilyIcon className="h-6 w-6" /> Dependentes ({dependants.length})
          </CardTitle>
        </CardHeader>
        <CardContent>
                ...
                {dependants.length > 0 ? (
                  ...
                  <TableRow>
                    <TableCell colSpan={3} className="h-24 text-center">
                      Nenhum dependente cadastrado para esta família.
                    </TableCell>
                  </TableRow>
                )}
              </TableBody>
