  ...
  return (
    ...
    >
      <DialogHeader>
        ...
        <DialogDescription>Preencha as informações abaixo. Clique em salvar para aplicar as mudanças.</DialogDescription>
      </DialogHeader>
      ...
      <DialogFooter>
        <Button type="button" variant="ghost" onClick={closeAndReset} disabled={isPending}>
          Cancelar
        </Button>
