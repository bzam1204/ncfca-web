...
export function EditClubForm({ club, onSuccess }: EditClubFormProps) {
  ...
  const { mutate: updateClub, isPending } = useUpdateMyClub();
  ...
  return (
    <DialogContent>
      <DialogHeader>
        ...
        <DialogDescription>Atualize os dados do seu clube. As alterações serão refletidas para todos os usuários.</DialogDescription>
      </DialogHeader>
